...
class _CardType4 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      clipBehavior: Clip.hardEdge, //Evita que los widget hijos salgan o desborden del widget padre.
      elevation: elevation,
      child: Stack(
        children: [
          Image.network(
            'https://cepr.org/sites/default/files/styles/16_9_small/public/2024-02/AdobeStock_388007642.jpeg?itok=TInGKlrc',
            height: 350,
            fit: BoxFit.cover,
          ),
          Align(
